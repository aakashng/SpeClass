...
cd(fileparts(which('Model_PersonalSCO_Optimize.m')))
currentDir = pwd;
slashdir = '/';
...
%% SAVE DATA
save('results_personalSCO_optimize.mat','optimized','averages')
fprintf('\n')
disp('Results saved (results_personalSCO_optimize.mat).')